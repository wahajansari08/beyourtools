...
export const metadata: Metadata = {
  ...
  description: "BeYourTools Privacy Policy. Learn how we collect, use, and protect your information. All tool processing happens in your browser - files are never uploaded.",
