    ...
    <div className="space-y-4">
      ...
      <div className="rounded-lg border border-amber-400/30 bg-amber-400/5 p-5">
        <div className="mb-2 flex items-center gap-2">
          ...
          <h2 className="text-sm font-semibold text-amber-300">Browser limitation</h2>
        </div>
        <p className="text-sm leading-relaxed text-mist-300">{reason}</p>
      </div>

      {/* Alternatives */}
      {alts.length > 0 && (
        <div className="rounded-lg border border-ink-700 bg-ink-900 p-5">
          <h3 className="mb-3 text-xs font-semibold uppercase tracking-wide text-mist-400">
            ...
            {alts.map((alt) => (
              <li key={alt.url}>
                <a
                  ...
                  className="focus-ring group inline-flex items-center gap-2 rounded text-sm text-teal-400 hover:text-teal-300"
                >
      ...
      {/* What we CAN do */}
      <div className="rounded-lg border border-ink-700 bg-ink-900 p-5">
        <h3 className="mb-2 text-xs font-semibold uppercase tracking-wide text-mist-400">What you can do here instead</h3>
        <p className="text-xs leading-relaxed text-mist-400">
          Try <strong className="text-mist-200">PDF to Text</strong> or <strong className="text-mist-200">PDF to JSON</strong> to extract
