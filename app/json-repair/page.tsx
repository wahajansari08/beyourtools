...
export default function Page() {
  return (
    <ToolLayout
      eyebrow="JSON Repair"
      title="JSON Repair"
      description="Paste broken or JS-style JSON and Jsonifyr will fix trailing commas, single quotes, unquoted keys, comments, and more."
