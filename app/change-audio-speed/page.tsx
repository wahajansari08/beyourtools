  ...
  return (
    <AudioToolPage
      ...
      howTo={[
        ...
        { title: "Export", text: "Click Export — FFmpeg re-encodes the audio at the new tempo." },
      ...
      faqs={[
        { question: "Does changing speed affect pitch?", answer: "Yes. This tool uses the FFmpeg atempo filter which changes both speed and pitch proportionally — faster audio sounds higher-pitched, slower audio sounds lower-pitched. Pitch-preserving time-stretching is not implemented." },
        { question: "What is the maximum speed?", answer: "Up to 4× using chained atempo filters. Very high speeds may produce unnatural results." },
