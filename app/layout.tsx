...
export const metadata: Metadata = {
  ...
  description: "200+ free browser-based tools — JSON formatter, image converter, PDF editor, audio tools, video tools, QR code generator and more. No upload, no sign-up.",
  ...
  twitter: {
    ...
    site: SITE.twitter,
    title: "BeYourTools — Free Online Tools for Everyone",
    description: "200+ free browser-based tools — JSON, image, PDF, audio, video, QR codes and more.",
