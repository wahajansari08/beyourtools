...
export const metadata: Metadata = {
  title: "QR & Barcode Tools - Free Online QR Code and Barcode Generator | BeYourTools",
  description:
    "Free browser-based QR code and barcode tools. Generate, scan and decode QR codes and barcodes — Code 128, EAN-13, UPC-A, WiFi QR and more. No upload, no sign-up.",
  keywords:
    "QR code generator, barcode generator, QR code scanner, barcode decoder, WiFi QR code, EAN-13, UPC barcode, Code 128, free online tools",
