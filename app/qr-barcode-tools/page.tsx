...
export const metadata: Metadata = {
  title: "QR & Barcode Tools - Free Online Generators | BeYourTools",
  description: "Free browser-based QR code and barcode tools to generate, scan, and decode Code 128, EAN, UPC, and WiFi codes. 100% private, no sign-up.",
  ...
  openGraph: {
    ...
    title: "QR & Barcode Tools - Free Online Generator | BeYourTools",
