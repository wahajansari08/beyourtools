...
export const videoTools: VideoTool[] = [
  {
    ...
    icon: "MP4",
    kind: "compress",
    title: "Video Compressor - Compress Video Free | BeYourTools",
  ...
  },
  {
    ...
    icon: "MP3",
    kind: "mp4-to-mp3",
    title: "MP4 to MP3 Converter - Extract Audio Online | BeYourTools",
  ...
  },
  {
    ...
    icon: "MOV",
    kind: "mov-to-mp4",
    title: "MOV to MP4 Converter - Convert Video Online | BeYourTools",
    metaDescription: "Convert MOV videos to MP4 format online for free. Control quality and resolution. Fast browser-based conversion.",
    tagline: "Turn Apple QuickTime MOV files into widely compatible MP4 videos without server uploads.",
    accept: "video/quicktime,.mov",
    acceptLabel: "QuickTime MOV files",
    outputExt: "mp4",
    outputMime: "video/mp4",
    ...
    features: ["QuickTime compatibility fix", "CRF quality tuning", "Local processing without size limits", "Instant preview"],
    faqs: [
      { question: "Why convert MOV to MP4?", answer: "MOV files are often larger and do not play on every Windows PC, Android phone, or website. MP4 is universally supported." },
      privacyFaq,
    ],
    related: ["video-converter", "mp4-to-mp3", "video-compressor", "video-cutter"],
    engine: "ffmpeg",
  },
  {
    slug: "mkv-to-mp4",
    ...
    icon: "MP4",
    kind: "mkv-to-mp4",
    title: "MKV to MP4 Converter - Convert Video Online | BeYourTools",
    metaDescription: "Convert MKV to MP4 online for free. Play your videos on any device. 100% browser-based processing.",
    tagline: "Re-package or transcode MKV videos into playable MP4 files in your browser.",
    accept: "video/x-matroska,.mkv",
    acceptLabel: "Matroska MKV files",
    outputExt: "mp4",
    outputMime: "video/mp4",
    processLabel: "Convert to MP4",
    formats: ["MKV", "MP4"],
    ...
    features: ["Transcode Matroska containers", "Preserve high visual quality", "Safe in-browser conversion", "Download when ready"],
    faqs: [
      { question: "Why will my MKV not play?", answer: "Many smart TVs, mobile browsers, and media players do not support MKV containers natively. MP4 solves this." },
      privacyFaq,
    ],
    related: ["video-converter", "mov-to-mp4", "webm-to-mp4", "video-compressor"],
    engine: "ffmpeg",
  },
  {
    slug: "webm-to-mp4",
    name: "WebM to MP4 Converter",
    description: "Convert WebM videos into standard MP4 for better compatibility.",
    category: "Compress & Convert",
    icon: "MP4",
    kind: "webm-to-mp4",
    title: "WebM to MP4 Converter - Convert Video Online | BeYourTools",
  ...
  },
  {
    ...
    icon: "SPD",
    kind: "speed",
    title: "Video Speed Changer - Change Speed Online | BeYourTools",
  ...
  },
  {
    ...
    icon: "IMG",
    kind: "thumbnail",
    title: "Video Thumbnail Generator - Free Online | BeYourTools",
  ...
  },
  {
    ...
    faqs: [
      { question: "Can I extract hundreds of frames?", answer: "This tool is built for smaller batches. Extracting too many frames at once can slow down your browser tab." },
      { question: "Why might MKV not work?", answer: "Frame capture relies on your native browser video player. If your browser cannot play MKV files directly, convert them to MP4 first." },
      privacyFaq,
    ],
