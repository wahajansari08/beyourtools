        ...
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-5">
          ...
          <div>
            ...
            <p className="mt-3 text-xs leading-relaxed" style={{ color: "var(--text-subtle)" }}>
              Free, private, client-side tools for developers and designers.
              Nothing is uploaded to a server — ever.
            </p>
          </div>
          ...
          {Object.entries(LINKS).map(([heading, items]) => (
            <div key={heading}>
              <h3 className="mb-3 text-[11px] font-semibold uppercase tracking-wide" style={{ color: "var(--text-subtle)" }}>
                {heading}
              </h3>
