        ...
        >
          <div className="flex items-start gap-3">
            ...
            <div className="space-y-1.5">
              ...
              <p>
                The outputs and estimates generated by the <strong style={{ color: "var(--text-primary)" }}>{title}</strong> are intended solely for general informational, educational, and personal planning purposes. Calculations rely on standard mathematical models, compound interest formulas, and user-provided inputs.
              </p>
              <p>
                BeYourTools is not a licensed financial advisory firm, certified financial planner (CFP), mortgage broker, lending institution, or certified public accountant (CPA). Figures generated by this calculator do not constitute an offer of credit, legal assessment, or formal financial consultation. Actual loan approvals, interest rates, closing fees, and tax consequences vary based on underwriting criteria and governing jurisdiction laws. For critical decisions, consult an accredited financial or tax professional. Read our complete{" "}
